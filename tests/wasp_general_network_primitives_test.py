...
class TestWNetworkIPV4:
	...
	def test_init(self):
		...
		assert(str(WNetworkIPV4.from_string('10.0.0.0/28')) == '10.0.0.0/28')
		assert(str(WNetworkIPV4.from_string('10.0.0.1/20', network_address=False)) == '10.0.0.1/20')

	def test_address(self):
		assert(isinstance(WNetworkIPV4.from_string('10.0.0.0/24').address(), WIPV4Address) is True)
		assert(int(WNetworkIPV4.from_string('0.0.1.0/24').address().bin_address()) == 256)
		assert(int(WNetworkIPV4(WIPV4Address('0.0.1.0'), 24).address().bin_address()) == 256)

	def test_mask(self):
		assert(isinstance(WNetworkIPV4.from_string('10.0.0.0/24').mask(), int) is True)
		assert(int(WNetworkIPV4.from_string('0.0.1.0/24').mask()) == 24)

	def test_first_address(self):
		assert(str(WNetworkIPV4.from_string('10.0.0.0/24').first_address()) == '10.0.0.1')
		...
		net = WNetworkIPV4.from_string('10.0.0.1/24', network_address=False)
		assert(str(net.first_address(skip_network_address=False)) == '10.0.0.0')

	def test_last_address(self):
		assert(str(WNetworkIPV4.from_string('10.0.0.0/23').last_address()) == '10.0.1.254')
		...
		net = WNetworkIPV4.from_string('10.0.0.1/23', network_address=False)
		assert(str(net.last_address(skip_broadcast_address=False)) == '10.0.1.255')

	def test_iterator(self):
		assert(len(list(WNetworkIPV4.from_string('10.0.0.0/32').iterator())) == 1)
		assert(str(list(WNetworkIPV4.from_string('10.0.0.0/32').iterator())[0]) == '10.0.0.0')
		...
		net = WNetworkIPV4.from_string('10.0.0.0/32')
		assert(len(list(net.iterator(skip_broadcast_address=False, skip_network_address=False))) == 1)

		assert(len(list(WNetworkIPV4.from_string('10.0.0.0/31').iterator())) == 2)
		assert(str(list(WNetworkIPV4.from_string('10.0.0.0/31').iterator())[0]) == '10.0.0.0')
		assert(str(list(WNetworkIPV4.from_string('10.0.0.0/31').iterator())[1]) == '10.0.0.1')
		assert(len(list(WNetworkIPV4.from_string('10.0.0.0/31').iterator(skip_network_address=False))) == 2)
		assert(len(list(WNetworkIPV4.from_string('10.0.0.0/31').iterator(skip_broadcast_address=False))) == 2)
		net = WNetworkIPV4.from_string('10.0.0.0/31')
		assert(len(list(net.iterator(skip_broadcast_address=False, skip_network_address=False))) == 2)

		assert(len(list(WNetworkIPV4.from_string('10.0.0.0/28').iterator())) == 14)
		assert(str(list(WNetworkIPV4.from_string('10.0.0.0/28').iterator())[0]) == '10.0.0.1')
		assert(str(list(WNetworkIPV4.from_string('10.0.0.0/28').iterator(skip_network_address=False))[0]) == '10.0.0.0')
		assert(str(list(WNetworkIPV4.from_string('10.0.0.0/28').iterator())[13]) == '10.0.0.14')
		assert(str(list(WNetworkIPV4.from_string('10.0.0.0/28').iterator(skip_broadcast_address=False))[14]) == '10.0.0.15')
		assert(len(list(WNetworkIPV4.from_string('10.0.0.0/28').iterator(skip_network_address=False))) == 15)
		assert(len(list(WNetworkIPV4.from_string('10.0.0.0/28').iterator(skip_broadcast_address=False))) == 15)
		net = WNetworkIPV4.from_string('10.0.0.0/28')
	...
	def test_contains(self):
		assert((WIPV4Address('192.168.0.1') in WNetworkIPV4.from_string('192.168.0.0/24')) is True)
		assert((WIPV4Address('192.168.0.1') in WNetworkIPV4.from_string('192.0.0.0/24')) is False)
		assert((WIPV4Address('192.168.0.0') in WNetworkIPV4.from_string('192.0.0.0/24')) is False)
...
class TestWFQDN:
	def test_fqdn(self):
		...
		assert(WFQDN('site1.org2.fld').to_string(leading_dot=True) == 'site1.org2.fld.')
		assert(WFQDN.from_string('').to_string(leading_dot=True) == '.')
