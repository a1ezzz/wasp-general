...
class WSyncTask(WStoppableTask, WTaskStatus, metaclass=ABCMeta):
	""" Main purpose for this class is to separate and to split big bunch of code into smaller stoppable parts
	"""
