...
class WMessengerOnionSessionFlow(WMessengerOnionSessionFlowProto):
	...
	# 	"""
	# 	if info:
	# 		for info_index, info_obj in enumerate(info):
	# 			yield WMessengerOnionSessionFlowProto.IteratorInfo(
	# 				info_obj.layer_name(),
	# 				**(info_obj.layer_args()[1])  # TODO: remove [1]
	# 			)
	#
	# 		#info = list(info)
	# 		#info.reverse()
	...
	# 		# 	info[0].layer_name(), **(info[0].layer_args()[1])
	# 		# )
	# 		#
	# 		# for i in range(1, len(info)):
	# 		# 	result = WMessengerOnionSessionFlowProto.Iterator(
	# 		# 		info[i].layer_name(), next_iterator=result, **(info[i].layer_args()[1])
	# 		# 	)
	# 		#
	# 		# return result
	#
	...
	# 	"""
	# 	if info:
	# 		return WMessengerOnionSessionFlow(tuple(WMessengerOnionSessionFlow.sequence(*info)))
